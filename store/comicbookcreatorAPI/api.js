...
function modules_files_uploads_list(payload) {
  return comicbookcreatorAPI.get(`/modules/files/uploads/`)
}
function modules_files_uploads_create(payload) {
  return comicbookcreatorAPI.post(`/modules/files/uploads/`, payload)
}
function modules_files_uploads_retrieve(payload) {
  return comicbookcreatorAPI.get(`/modules/files/uploads/${payload.id}/`)
}
function modules_files_uploads_update(payload) {
  return comicbookcreatorAPI.put(
    `/modules/files/uploads/${payload.id}/`,
    payload
  )
}
function modules_files_uploads_partial_update(payload) {
  return comicbookcreatorAPI.patch(
    `/modules/files/uploads/${payload.id}/`,
    payload
  )
}
function modules_files_uploads_destroy(payload) {
  return comicbookcreatorAPI.delete(`/modules/files/uploads/${payload.id}/`)
}
